export const featureItems = [
  {
    ...
    description:
      "Trust is the foundation of everything we do. We are clear about titles, timelines, and pricing, and we tell you what you need to hear, not what is easy to say.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    description:
      "Decades of work on the Abuja property market, careful relationships built over time, and a steady hand on every deal. We do the legwork so you do not have to.",
  },
  {
    id: 3,
    ...
    title: "Impeccable customer satisfaction",
    description:
      "We keep clients informed at every step, and we stay in touch after a deal closes. Most of our business comes through referrals, and we plan to keep it that way.",
  },
];
