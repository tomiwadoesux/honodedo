export const featureItems = [
  {
    ...
    description:
      "Trust is the foundation of everything we do, and we’re committed to being transparent, ethical, and dependable.",
  },
  {
    id: 2,
    className: "col-md-4 col-lg-3 d-flex align-items-stretch mb-sm-30",
    ...
    description:
      "With deep industry knowledge and a strong work ethic, we bring experience, precision, and care to every property transaction and client interaction.",
  },
  {
    id: 3,
    ...
    description:
      "From the first conversation to the final handshake, we go above and beyond to make your experience smooth, rewarding, and stress-free.",
  },
];
